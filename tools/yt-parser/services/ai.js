...
15. НИКОГДА не упоминай конкретные названия видео блогера в письме. Данные о видео, описания, теги — это твои ВНУТРЕННИЕ знания для понимания ниши, тона и аудитории. Используй их для выбора правильного угла и тона, но НЕ цитируй и НЕ ссылайся на конкретные ролики. Блогер должен чувствовать что ты понимаешь его нишу, а не что ты погуглил его канал.`;
}
